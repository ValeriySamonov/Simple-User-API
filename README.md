...
Проект Simple User API представляет собой простую реализацию пользовательского API, позволяющую осуществлять основные операции по хранению информации о пользователях и их контактой информации.
